...
public class LocacaoServiceTest {
    ...
    public void deveProrrogarLocacao() {
        ...
        // cenário
        Locacao loc = LocacaoBuilder.umaLocacao().agora();
        ...
        Locacao locRetornada = argumentCaptor.getValue();

        error.checkThat(locRetornada.getValor(), CoreMatchers.is(12.0));
        error.checkThat(locRetornada.getDataLocacao(), MatchersProperties.ehHoje());
        error.checkThat(DataUtils.isMesmaData(locRetornada.getDataRetorno(), DataUtils.obterDataComDiferencaDias(3)), CoreMatchers.is(true));
    }
